...
VALUES (1, 'G', 'van', 'Rijn', TO_DATE('17-09-2002', 'dd-mm-yyyy')),
       ...
       (6, 'A', NULL, 'Albrechts', TO_DATE('03-12-2002', 'dd-mm-yyyy')),
       (7, 'J', NULL, 'Mems', TO_DATE('17-09-2002', 'dd-mm-yyyy')),
       (8, 'Z', NULL, 'Denk', TO_DATE('03-12-2002', 'dd-mm-yyyy')),
       (77, 'A', NULL, 'Shagur', TO_DATE('01-12-2002', 'dd-mm-yyyy')),
       (88, 'A', NULL, 'Shagur', TO_DATE('01-12-2002', 'dd-mm-yyyy'));
...
VALUES (35283, TO_DATE('31-05-2018', 'dd-mm-yyyy'), 2, 25.50, 2),
       ...
       (12543, TO_DATE('31-12-2017', 'dd-mm-yyyy'), 2, 0.0, 77),
       (65427, TO_DATE('31-12-2017', 'dd-mm-yyyy'), 2, 0.0, 77),
       (81267, TO_DATE('31-12-2017', 'dd-mm-yyyy'), 2, 0.0, 88);
...
VALUES (1, 'Dagkaart 2e klas', 'Een hele dag onbeperkt reizen met de trein.', 50.60),
       ...
       (7, 'ToDelete', 'Gemarkeerd om te verwijderen', 0.0);
...
VALUES (35283, 3, 'actief', TO_DATE('31-05-2017', 'dd-mm-yyyy')),
       ...
       (81267, 7, 'gekocht', TO_DATE('14-04-2018', 'dd-mm-yyyy'));
